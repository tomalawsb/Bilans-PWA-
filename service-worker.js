const CACHE_NAME = 'portfel-pro-etap38-v1';
const APP_VERSION = '38';
const APP_SHELL = [
  './',
  './index.html',
  './index.html?v=38',
  './voice/index.html?v=38',
  './manifest.webmanifest?v=38',
  './manifest-voice.webmanifest?v=38',
  './src/styles.css?v=38',
  './src/config.js?v=38',
  './src/app.js?v=38',
  './icons/icon-192.png',
      ...
      .catch(async () => {
        ...
        if (event.request.mode === 'navigate') {
          if (requestUrl.pathname.endsWith('/voice/') || requestUrl.pathname.endsWith('/voice/index.html')) {
            return await caches.match('./voice/index.html?v=38') || await caches.match('./voice/index.html') || await caches.match('./index.html?v=38');
          }
          return await caches.match('./index.html?v=38') || await caches.match('./index.html');
        }
