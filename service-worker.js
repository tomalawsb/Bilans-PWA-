const CACHE_NAME = 'portfel-pro-v1-1-v130';
const APP_VERSION = '1.1-130';
const APP_SHELL = [
  './',
  './index.html',
  './index.html?v=130',
  './voice/index.html?v=130',
  './manifest.webmanifest?v=130',
  './manifest-voice.webmanifest?v=130',
  './src/styles.css?v=130',
  './src/config.js?v=130',
  './src/app.js?v=130',
  './icons/icon-192.png',
  './icons/icon-512.png',
      ...
      .catch(async () => {
        ...
        if (event.request.mode === 'navigate') {
          if (requestUrl.pathname.endsWith('/voice/') || requestUrl.pathname.endsWith('/voice/index.html')) {
            return await caches.match('./voice/index.html?v=130') || await caches.match('./voice/index.html') || await caches.match('./index.html?v=130');
          }
          return await caches.match('./index.html?v=130') || await caches.match('./index.html');
        }
