...
## Wersja 1.1 / 126
- Dodano zakładkę Magazyn.
- Dodano ustawienia AI: dostawca Gemini/OpenAI, klucz API, model i test klucza.
- Dodano automatyczne rozpoznawanie zakupów i sprzedaży z firmowych wpisów.
- Dodano zabezpieczenie przed ponownym naliczaniem tych samych wpisów: wpis ma zapamiętany skrót treści i powiązany ruch magazynowy.
- Dodano eksport/import danych magazynowych razem z kopią JSON/Dropbox.
